  ...
  return (
    <>
      <p className="font-light max-sm:mx-3 max-sm:text-xl sm:text-2xl md:text-4xl mt-8 text-center">
        Yana Fishingga ilinib qolmang ! 👮‍♂️
      </p>

      <p className="font-normal mt-1 text-center text-gray-500 text-sm sm:text-lg mx-7">
        Fishing tuzog'iga tushmang. Yiliga 2,6 million marta Fishing holatlari sodir bo'ladi,
        ammo bizning ilovamiz yordamida siz o'zingizni himoya qilishingiz mumkin..
      </p>
      ...
      <div className="flex max-md:flex-col md:flex-row mt-5">
        ...
        <input type="text" placeholder="Veb-sayt manzili yoki URL manzilini kiriting (masalan, www.csec.uz)" onChange={(event) => setUrl(event.target.value)}
