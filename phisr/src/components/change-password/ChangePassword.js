    ...
    return (
        <>
            ...
            <div className="bg-white min-h-screen pt-7 flex flex-col items-center">
                ...
                <p className='max-[450px]:text-xl text-2xl mb-8 font-semibold text-black'> Akkaunt parolini o'zgartirish </p>
                ...
                <div className="flex items-center  bg-gray-200 hover:bg-gray-300 rounded-md mb-5">
                    <RiLockPasswordLine className="ml-3 text-slate-500 h-6 w-6" />
                    <input placeholder="Yangi parolni kiriting" type={showNewPassword ? 'text' : 'password'}
                ...
                <div className="flex items-center bg-gray-200 hover:bg-gray-300 rounded-md mb-5">
                    <RiLockPasswordLine className="ml-3 text-slate-500 h-6 w-6" />
                    <input placeholder="Yangi parolni tasdiqlang" type={showNewPassword ? 'text' : 'password'}
