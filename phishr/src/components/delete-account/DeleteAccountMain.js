        ...
        <>
            ...
            <div className="bg-white min-h-screen flex flex-col pt-8 items-center">
                ...
                <p className="text-gray-800 text-center  max-sm:text-xs text-sm sm:text-base mx-5 min-[500px]:mx-14 lg:mx-44 min-[1100px]:mx-72">
                    Davom etishdan oldin, saqlamoqchi bo'lgan muhim ma'lumotlarni eksport qilgan yoki saqlaganingizga ishonch hosil qiling.
                    Hisobingizni o'chirib tashlasangiz, u bilan bog'liq barcha ma'lumotlar ham o'chiriladi va uni qayta tiklab bo'lmaydi.
                </p>
