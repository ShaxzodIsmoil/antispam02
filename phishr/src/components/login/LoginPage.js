...
const LoginPage = () => {
    ...
    const handleSignInWithGoogle = async () => {
        try {
            ...
            console.error('Google hisobiga kirishda xatolik yuz berdi:', error);
        }
    };
            ...
            <div className="bg-transparent min-h-screen pt-6 flex flex-col items-center">
                ...
                <div className="w-3/4 max-w-md">
                    <div className="flex items-center bg-gray-200 hover:bg-gray-300 rounded-md mb-5">
                        <input
                            placeholder="Email pochta ro'yxatdan o'tqazish"
                            type="text"
                ...
                <div className="mt-5">
                    <span className="text-gray-700 text-base font-medium">Akkaunting yo'qmi</span>
